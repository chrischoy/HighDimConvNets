...
class SimpleNet2(ME.MinkowskiNetwork):
  ...
  def __init__(self,
    ...
    self.conv1_tr = ME.MinkowskiConvolution(
        ...
        has_bias=False,
        dimension=D)
    self.norm1_tr = get_norm(NORM_TYPE, TR_CHANNELS[1], bn_momentum=bn_momentum, dimension=D)
...
class SimpleNet3(ME.MinkowskiNetwork):
  ...
  def __init__(self,
    ...
    self.conv5_tr = ME.MinkowskiConvolutionTranspose(
        ...
        has_bias=False,
        dimension=D)
    self.norm5_tr = get_norm(NORM_TYPE, TR_CHANNELS[5], bn_momentum=bn_momentum, dimension=D)
