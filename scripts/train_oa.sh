...
export DATA_ROOT="./outputs/OA"
export TRAINER=${TRAINER:-OATrainer}
export INLIER_MODEL=${INLIER_MODEL:-OANet}
export DATASET=${DATASET:-YFCC100MDatasetExtracted}
export OPTIMIZER=${OPTIMIZER:-Adam}
export LR=${LR:-1e-4}
export MAX_EPOCH=${MAX_EPOCH:-250}
export BATCH_SIZE=${BATCH_SIZE:-32}
export INLIER_THRESHOLD_PIXEL=${INLIER_THRESHOLD_PIXEL:-0.01}
export COLLATION_2D=${COLLATION_2D:-collate_oa}
